        ...
        <div className='grid lg:grid-cols-2 lg:justify-center gap-16 items-center py-12'>
          <div >
            <div className='space-y-3'>
              <h1 className='md:text-5xl text-3xl font-bold  font-sans '>PPC AND GOOGLE ADWORD MANAGEMENT SERVICES
              </h1>
              <p className='text-[16px] font-normal'>Maximize your online presence with our expert PPC and Google AdWords management. Harnessing data-driven strategies, we elevate your campaigns for optimal ROI, driving targeted traffic and conversions.</p>
            </div>
